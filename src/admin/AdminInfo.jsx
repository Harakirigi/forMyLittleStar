...
const AdminInfo = () => {
    ...
    useEffect(() => {
        const getInfo = async () => {
            try {
                ...
                const resStar = await axios.get(`https://formylittlestarbackend-production.up.railway.app/star/${starId}`)
                const resQuestion = await axios.get(`https://formylittlestarbackend-production.up.railway.app/star/${starId}/question`)
                const resChoice = await axios.get(`https://formylittlestarbackend-production.up.railway.app/star/${starId}/choice`)
                setStar(resStar)
    ...
    const answerSubmit = async (starId, questionId) => {
        try {
            const res = await axios.post(`https://formylittlestarbackend-production.up.railway.app/star/${starId}/question/${questionId}/answer`, {answerContent: answer})
    ...
    const deleteUser = async () => {
        const starId = localStorage.getItem("id-for-search")
        try {
            await axios.delete(`https://formylittlestarbackend-production.up.railway.app/star/${starId}`)
            navigate("/admin")
